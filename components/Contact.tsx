...
export const Contact: React.FC = () => {
  ...
  return (
    <footer id="contact" className="bg-[#1a0508] text-beige-100 relative overflow-hidden">
      {/* Decorative Texture */}
            ...
            <div className="space-y-12">
                <div className="group relative">
                  <input 
                    ...
                    className="block w-full bg-transparent border-b border-white/20 py-3 text-xl text-white placeholder-transparent focus:outline-none focus:border-white transition-colors peer font-serif"
                    placeholder="Name"
                  />
                  <label htmlFor="name" className="absolute left-0 top-3 text-white/40 text-xs uppercase tracking-widest transition-all duration-300 peer-focus:-top-4 peer-focus:text-[10px] peer-focus:text-white peer-not-placeholder-shown:-top-4 peer-not-placeholder-shown:text-[10px] peer-not-placeholder-shown:text-white cursor-text pointer-events-none">
                    Your Name
                  </label>
                </div>
                ...
                <div className="group relative">
                  <input 
                    ...
                    placeholder="Brand"
                  />
                  <label htmlFor="brand" className="absolute left-0 top-3 text-white/40 text-xs uppercase tracking-widest transition-all duration-300 peer-focus:-top-4 peer-focus:text-[10px] peer-focus:text-white peer-not-placeholder-shown:-top-4 peer-not-placeholder-shown:text-[10px] peer-not-placeholder-shown:text-white cursor-text pointer-events-none">
                    Brand / Company
                  </label>
                </div>
                ...
                <div className="group relative">
                  <textarea 
                    ...
                    onChange={handleChange}
                    rows={1}
                    className="block w-full bg-transparent border-b border-white/20 py-3 text-xl text-white placeholder-transparent focus:outline-none focus:border-white transition-colors peer font-serif resize-none"
                    placeholder="Message"
                  ></textarea>
                  <label htmlFor="message" className="absolute left-0 top-3 text-white/40 text-xs uppercase tracking-widest transition-all duration-300 peer-focus:-top-4 peer-focus:text-[10px] peer-focus:text-white peer-not-placeholder-shown:-top-4 peer-not-placeholder-shown:text-[10px] peer-not-placeholder-shown:text-white cursor-text pointer-events-none">
                    Short Message
                  </label>
                </div>
                ...
                <div className="pt-4">
                  <a href={getMailtoLink()} className="block w-full group">
                    <button type="button" className="w-full bg-white text-black hover:bg-beige-200 transition-colors py-4 px-6 flex items-center justify-between">
